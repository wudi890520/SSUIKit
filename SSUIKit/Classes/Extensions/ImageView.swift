...
public extension SSUIImageViewCompatible where Self: UIImageView {
    ...
    /// - Returns: UIImageView
    @discardableResult
    public func ss_image(_ image: UIImage?) -> Self {
        self.image = image
        return self
    }
    ...
    /// - Returns: UIImageView
    @discardableResult
    public func ss_contentMode(_ contentMode: UIView.ContentMode = .scaleAspectFill) -> Self {
    ...
    /// - Returns: UIImageView
    @discardableResult
    public func ss_kingfisherImage(_ urlString: String?, placeholder: UIImage? = nil, completion: ((UIImage?) ->Void)? = nil) -> Self {
