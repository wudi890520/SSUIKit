...
public extension SSUILabelCompatible where Self: UILabel {
    ...
    /// - Returns: UILabel
    @discardableResult
    public func ss_text(_ value: Any?) -> Self {
        if let value = value {
            self.text = "\(value)"
        }
        return self
    ...
    /// - Returns: UILabel
    @discardableResult
    public func ss_attribute(_ attribute: NSMutableAttributedString?) -> Self {
    ...
    /// - Returns: UILabel
    @discardableResult
    public func ss_textColor(_ color: UIColor?) -> Self {
    ...
    /// - Returns: UILabel
    @discardableResult
    public func ss_textAlignment(_ textAlignment: NSTextAlignment) -> Self {
...
public extension UILabel {
    ...
    /// 复制文本之后的回调通知名称
    public static var ss_copiedNotification: Notification.Name {
...
extension UILabel {
    ...
    /// - Returns: UILabel
    @discardableResult
    public func ss_fitWidth(with edge: CGFloat = 0) -> Self {
...
extension QMUILabel {
    ...
    /// 控制label内容的padding
    @discardableResult
    public func ss_contentInset(top: CGFloat, left: CGFloat, bottom: CGFloat, right: CGFloat) -> Self {
    ...
    @discardableResult
    public func ss_canPerformCopyAction() -> Self {
