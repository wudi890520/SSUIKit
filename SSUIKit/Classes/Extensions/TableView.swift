...
public extension UITableView {
    ...
    /// 空列表图片
    public var ss_emptyDataImage: UIImage? {
    ...
    /// 空列表标题
    public var ss_emptyDataTitle: String? {
    ...
    /// 空列表副标题
    public var ss_emptyDataSubtitle: String? {
    ...
    /// 空列表按钮标题
    public var ss_emptyDataButtonTitle: String? {
    ...
    /// 加载中视图
    public var ss_loadingView: UIView? {
    ...
    /// 空列表时的按钮
    public var ss_emptyDataButton: UIButton? {
...
public extension SSUITableViewCompatible where Self: UITableView {
    ...
    ///
    /// - Returns: UITableView
    public static func ss_plain() -> UITableView {
    ...
    ///
    /// - Returns: UITableView
    public static func ss_grouped() -> UITableView {
...
extension SSUITableViewCompatible where Self: UITableView {
    ...
    /// - Returns: UITableView
    @discardableResult
    public func ss_hideSeparator() -> Self {
    ...
    /// - Returns: UITableView
    @discardableResult
    public func ss_separatorStyleNone() -> Self {
        separatorStyle = .none
    ...
    /// - Returns: UITableView
    @discardableResult
    public func ss_rowHeight(_ rowHeight: CGFloat) -> Self {
    ...
    /// - Returns: UITableView
    @discardableResult
    public func ss_disableEstimated() -> Self {
    ...
    /// - Returns: UITableView
    @discardableResult
    public func ss_tableHeaderView(_ tableHeaderView: UIView?) -> Self {
    ...
    /// - Returns: UITableView
    @discardableResult
    public func ss_tableFooterView(_ tableFooterView: UIView?) -> Self {
    ...
    /// - Returns: UITableView
    @discardableResult
    public func ss_addEmptyHeader(_ headerViewHeight: CGFloat = 1 / UIScreen.main.scale) -> Self {
    ...
    /// - Returns: UITableView
    @discardableResult
    public func ss_clipsToBounds() -> Self {
        clipsToBounds = true
        return self
    }
    ...
    @discardableResult
    public func ss_sectionIndexColor(_ color: UIColor?) -> Self {
    ...
    /// - Returns: UITableView
    @discardableResult
    public func ss_registerLoadingView<T: UIView>(_ classType: T.Type, space: CGFloat = 10, loadingType: SSTableLoadingViewType = .cell) -> Self {
        if loadingType == .cell {
    ...
    /// - Parameter color: UITableView
    @discardableResult
    public func ss_addRefreshHeader() -> Self {
        addRefreshHeader()
        return self
    }
    ...
    /// - Parameter color: UITableView
    @discardableResult
    public func ss_addRefreshFooter() -> Self {
        addRefreshFooter()
        return self
    }
    ...
    /// - Parameter color: UITableView
    @discardableResult
    public func ss_addEmptyDataButton() -> Self {
