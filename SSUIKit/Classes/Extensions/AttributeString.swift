...
public extension NSMutableAttributedString {
    ...
    @discardableResult
    func ss_color(color: UIColor?, with text: String? = nil) -> NSMutableAttributedString {
    ...
    @discardableResult
    func ss_backgroundColor(color: UIColor?, with text: String? = nil) -> NSMutableAttributedString {
        guard let color = color else { return self }
    ...
    /// - Returns: NSMutableAttributedString
    @discardableResult
    func ss_alignment(alignment: NSTextAlignment, with lineSpacing: CGFloat = 0, with text: String? = nil) -> NSMutableAttributedString {
        var str = text.orEmpty
        if text == nil {
            str = self.string
        }
    ...
    /// - Returns: NSMutableAttributedString
    @discardableResult
    func ss_addAttribute(key: NSAttributedString.Key, value: Any? = nil, with text:String? = nil) -> NSMutableAttributedString{
        var str = text.orEmpty
        if text == nil {
            str = self.string
        }
    ...
    /// - Returns: NSMutableAttributedString
    @discardableResult
    func ss_image(image: UIImage?, bounds: CGRect, behind text: String? = nil, insertAtFirst: Bool = false) -> NSMutableAttributedString {
    ...
    /// - Returns: NSMutableAttributedString
    @discardableResult
    func ss_alignment(_ aligment: NSTextAlignment, lineSpacing: CGFloat? = nil) -> NSMutableAttributedString {
        let paragraph = NSMutableParagraphStyle()
