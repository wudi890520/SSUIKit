...
public extension SSUIButtonCompatible where Self: UIButton {
    ...
    /// - Returns: UIButton
    @discardableResult
    public func ss_title(_ title: Any?, for state: UIControl.State? = .normal) -> Self {
    ...
    /// - Returns: UIButton
    @discardableResult
    public func ss_attributeTitle(_ title: NSMutableAttributedString?, for state: UIControl.State? = .normal) -> Self {
        if let state = state {
    ...
    /// - Returns: UIButton
    @discardableResult
    public func ss_titleColor(_ color: UIColor?, for state: UIControl.State? = .normal) -> Self {
    ...
    /// - Returns: UIButton
    @discardableResult
    public func ss_image(_ image: UIImage?, for state: UIControl.State? = .normal) -> Self {
    ...
    /// - Returns: UIButton
    @discardableResult
    public func ss_backgroundImage(_ image: UIImage?, for state: UIControl.State? = .normal) -> Self {
        if let state = state {
    ...
    /// - Returns: UIButton
    @discardableResult
    public func ss_backgroundImage(_ color: UIColor? = .white, for state: UIControl.State? = .normal) -> Self {
        var image: UIImage?
    ...
    /// - Parameter font: 字体
    @discardableResult
    public func ss_font(_ font: UIFont) -> Self {
    ...
    /// - Returns: UIButton
    @discardableResult
    public func ss_font(_ fontSize: CGFloat, isBold: Bool? = false) -> Self {
        if isBold == true {
    ...
    /// - Returns: UIButton
    @discardableResult
    public func ss_horizontalAlignment(_ contentHorizontalAlignment: UIControl.ContentHorizontalAlignment) -> Self {
    ...
    /// - Returns: UIButton
    @discardableResult
    public func ss_verticalAlignment(_ contentVerticalAlignment: UIControl.ContentVerticalAlignment) -> Self {
    ...
    /// - Returns: UIButton
    @discardableResult
    public func ss_contentMode(_ mode: UIView.ContentMode = .scaleAspectFill) -> Self {
    ...
    /// - Returns: UIButton
    @discardableResult
    public func ss_numberOfLines(_ numberOfLines: Int = 0) -> Self {
    ...
    /// - Returns: UIImageView
    @discardableResult
    public func ss_kingfisherImage(_ urlString: String?, placeholder: UIImage? = nil) -> Self {
...
public extension UIButton {
    ...
    /// 获取按钮标题
    public var ss_title: String { return titleLabel?.text ?? "" }
    
    /// 标题字体大小
    public var ss_fontSize: CGFloat { return titleLabel?.font.pointSize ?? 0 }
...
public extension UIButton {
    ...
    /// - Returns: UILabel
    @discardableResult
    public func ss_fitHeight(with edge: CGFloat = 0) -> Self {
    ...
    /// - Returns: UIButton
    @discardableResult
    public func ss_fitWidth(with space: CGFloat = 0) -> Self {
        guard let titleLabel = titleLabel, let font = titleLabel.font else { return self }
    ...
    /// - Returns: UIButton
    @discardableResult
    public func ss_addEdge(with space: CGFloat = 5) -> Self {
    ...
    /// - Returns: UIButton
    @discardableResult
    public func ss_titleEdgeInsets(_ contentInsets: UIEdgeInsets) -> Self {
    ...
    /// - Returns: UIButton
    @discardableResult
    public func ss_imageEdgeInsets(_ contentInsets: UIEdgeInsets) -> Self {
...
public extension QMUIButton {
    ...
    @discardableResult
    public func ss_style(_ style: SSButtonStyle) -> QMUIButton {
        switch style {
    ...
    @discardableResult
    public func ss_tintColor(_ color: UIColor, strategy: SSButtonTintColorStrategy) -> Self {
        tintColor = color
    ...
    @discardableResult
    public func ss_highlightedBackgroundColor(_ color: UIColor, isLight: Bool = true, progress: CGFloat? = nil) -> Self {
    ...
    @discardableResult
    public func ss_imagePosition(_ position: QMUIButtonImagePosition, spacing: CGFloat = 8) -> Self {
